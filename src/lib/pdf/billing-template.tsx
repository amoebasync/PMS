...
const S = StyleSheet.create({
  ...
  docSub: { fontSize: 8, color: '#334155', marginBottom: 1 },

  divider: { height: 1, backgroundColor: '#e2e8f0', marginBottom: 14 },

  metaRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 16 },
  toBlock: { flex: 1 },
  toLabel: { fontSize: 8, color: '#475569', marginBottom: 3 },
  ...
  metaValue: { fontSize: 8, color: '#0f172a', fontWeight: 700 },
  ...
  tableHead: { flexDirection: 'row', backgroundColor: '#e2e8f0', borderRadius: 2, padding: '4 6', marginBottom: 1 },
  tableRow: { flexDirection: 'row', borderBottom: '1 solid #f1f5f9', padding: '4 6' },
  colNo:    { width: 110, fontSize: 8, color: '#334155' },
  colTitle: { flex: 1,   fontSize: 8, color: '#334155' },
  colSub:   { width: 70, fontSize: 8, color: '#334155', textAlign: 'right' },
  colTax:   { width: 60, fontSize: 8, color: '#334155', textAlign: 'right' },
  colAmt:   { width: 75, fontSize: 8, color: '#334155', textAlign: 'right' },
  colNoH:   { width: 110, fontSize: 8, fontWeight: 700, color: '#475569' },
  colTitleH:{ flex: 1,   fontSize: 8, fontWeight: 700, color: '#475569' },
  colSubH:  { width: 70, fontSize: 8, fontWeight: 700, color: '#475569', textAlign: 'right' },
  colTaxH:  { width: 60, fontSize: 8, fontWeight: 700, color: '#475569', textAlign: 'right' },
  colAmtH:  { width: 75, fontSize: 8, fontWeight: 700, color: '#475569', textAlign: 'right' },

  // 合計サマリー
  summarySection: { alignItems: 'flex-end', marginBottom: 16 },
  summaryRow: { flexDirection: 'row', justifyContent: 'flex-end', width: 200, marginBottom: 2 },
  summaryLabel: { width: 90, fontSize: 8, color: '#475569', textAlign: 'right', marginRight: 8 },
  summaryValue: { width: 80, fontSize: 8, color: '#0f172a', textAlign: 'right' },
  summaryDivider: { width: 200, height: 1, backgroundColor: '#cbd5e1', marginVertical: 3 },
  ...
  // 振込先・備考
  bankBox: {
    borderTop: '1 solid #e2e8f0', paddingTop: 10, marginTop: 4,
    flexDirection: 'row', gap: 20,
  },
  bankSection: { flex: 1 },
  bankTitle: { fontSize: 8, fontWeight: 700, color: '#475569', marginBottom: 4 },
  bankRow: { flexDirection: 'row', marginBottom: 2 },
  bankLabel: { width: 70, fontSize: 8, color: '#64748b' },
  bankValue: { flex: 1, fontSize: 8, color: '#0f172a' },
  noteSection: { flex: 1 },
  noteText: { fontSize: 8, color: '#334155', lineHeight: 1.6 },
});
