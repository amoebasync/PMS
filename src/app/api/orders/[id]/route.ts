  ...
  try {
    ...
    if (tab === 'BASIC') {
      ...
      const data = {
        ...
        distributionUnitPrice: body.distributionUnitPrice !== '' && body.distributionUnitPrice != null ? parseFloat(body.distributionUnitPrice) : null,
      ...
      const data = {
        ...
        printingUnitPrice: body.printingUnitPrice !== '' && body.printingUnitPrice != null ? parseFloat(body.printingUnitPrice) : null,
