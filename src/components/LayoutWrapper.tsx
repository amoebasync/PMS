...
const PAGE_ICONS: Record<string, string> = {
  ...
  '/distributor-announcements':     'bi-megaphone-fill',
  ...
  '/analytics/salary':              'bi-currency-yen',
  '/analytics/areas':               'bi-bar-chart-line-fill',
...
const PAGE_TITLE_KEYS: Record<string, string> = {
  ...
  '/picking':                       'page_titles.picking_verification',
  ...
  '/distributor-announcements':     'page_titles.distributor_announcements',
  ...
  '/analytics/salary':              'page_titles.salary_analytics',
  '/analytics/areas':               'page_titles.area_analytics',
