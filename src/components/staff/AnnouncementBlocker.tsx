...
import { AnnouncementBody } from './AnnouncementRenderer';
    ...
    <div className="fixed inset-0 z-[9999] bg-black/60 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col max-h-[90vh]">
        ...
        >
          ...
          {/* Text content - rendered with basic formatting */}
          <AnnouncementBody text={displayContent} />
        </div>
...
// AnnouncementBody is now imported from ./AnnouncementRenderer
